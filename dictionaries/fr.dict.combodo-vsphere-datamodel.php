...
Dict::Add('FR FR', 'French', 'Français', [
    ...
    'Class:Datastore/Attribute:status' => 'Etat',
    'Class:Datastore/Attribute:status+' => '',
    'Class:Datastore/Attribute:status/Value:implementation' => 'Implémentation',
    'Class:Datastore/Attribute:status/Value:implementation+' => '',
    'Class:Datastore/Attribute:status/Value:obsolete' => 'Obsolète',
