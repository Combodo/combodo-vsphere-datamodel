...
Dict::Add('CS CZ', 'Czech', 'Čeština', [
    ...
    'Class:Datastore/Attribute:status/Value:implementation+' => '',
    'Class:Datastore/Attribute:status/Value:obsolete' => 'zastaralé',
    'Class:Datastore/Attribute:status/Value:obsolete+' => '',
    'Class:Datastore/Attribute:status/Value:production' => 'v produkci',
    'Class:Datastore/Attribute:status/Value:production+' => '',
    'Class:Datastore/Attribute:status/Value:stock' => 'skladem/rezerva',
    'Class:Datastore/Attribute:status/Value:stock+' => '',
